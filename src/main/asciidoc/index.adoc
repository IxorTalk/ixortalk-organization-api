...
== Find all Users By Login and Status

Find call that queries users filtering on login and status.

=== Request

Via curl:
include::{snippets}/users/find-all-by-login-and-status/ok/curl-request.adoc[]

HTTP request:
include::{snippets}/users/find-all-by-login-and-status/ok/http-request.adoc[]

Including paging and sorting:

Via curl:
include::{snippets}/users/find-all-by-login-and-status/paging-and-sorting/curl-request.adoc[]

HTTP request:
include::{snippets}/users/find-all-by-login-and-status/paging-and-sorting/http-request.adoc[]


==== Request Headers
include::{snippets}/users/find-all-by-login-and-status/ok/request-headers.adoc[]

==== Request Parameters
include::{snippets}/users/find-all-by-login-and-status/ok/request-parameters.adoc[]

Including paging and sorting:

include::{snippets}/users/find-all-by-login-and-status/paging-and-sorting/request-parameters.adoc[]

=== Response

Success:

include::{snippets}/users/find-all-by-login-and-status/ok/http-response.adoc[]

When the user has no access to the organization:

include::{snippets}/users/find-all-by-login-and-status/access-denied/http-response.adoc[]

Including paging and sorting:

include::{snippets}/users/find-all-by-login-and-status/paging-and-sorting/http-response.adoc[]
...
Generic, config based, `/save-*` calls are available to save device properties.  The configuration determines which paths are allowed to save, and for each allowed path, a list of allowed keys is specified.

Examples below have been executed for config:
...
Via curl:
include::{snippets}/organizations/save-device-properties/ok/curl-request.adoc[]

HTTP request:
include::{snippets}/organizations/save-device-properties/ok/http-request.adoc[]

==== Request Headers
include::{snippets}/organizations/save-device-properties/ok/request-headers.adoc[]

==== Path Parameters
include::{snippets}/organizations/save-device-properties/ok/path-parameters.adoc[]

==== Request Fields
include::{snippets}/organizations/save-device-properties/ok/request-fields.adoc[]

=== Response

As organization admin:

include::{snippets}/organizations/save-device-properties/ok/http-response.adoc[]

When the save path is not a valid/configured path:

include::{snippets}/organizations/save-device-properties/unallowed-path/http-request.adoc[]
include::{snippets}/organizations/save-device-properties/unallowed-path/http-response.adoc[]

When the payload contains a property which is not allowed by the config:

include::{snippets}/organizations/save-device-properties/unallowed-property/http-request.adoc[]
include::{snippets}/organizations/save-device-properties/unallowed-property/http-response.adoc[]

As a user:

include::{snippets}/organizations/save-device-properties/as-user/http-response.adoc[]

As an organization admin from a different organization:

include::{snippets}/organizations/save-device-properties/different-admin/http-response.adoc[]

When the organization does not exist:

include::{snippets}/organizations/save-device-properties/organization-does-not-exist/http-response.adoc[]

When the device does not exist:

include::{snippets}/organizations/save-device-properties/deviceid-does-not-exist/http-response.adoc[]
...
Via curl:
include::{snippets}/organizations/promote-to-admin/ok/curl-request.adoc[]

HTTP request:
include::{snippets}/organizations/promote-to-admin/ok/http-request.adoc[]

==== Request Headers
include::{snippets}/organizations/promote-to-admin/ok/request-headers.adoc[]

==== Path Parameters
include::{snippets}/organizations/promote-to-admin/ok/path-parameters.adoc[]

=== Response

Success when executed as an organization admin:

include::{snippets}/organizations/promote-to-admin/ok/http-response.adoc[]

When executed as a user of the same organization:

include::{snippets}/organizations/promote-to-admin/as-user-of-org-x/http-response.adoc[]

When executed as an admin of a different organization:

include::{snippets}/organizations/promote-to-admin/admin-of-org-y/http-response.adoc[]

== Remove Organization Admin Rights from User

=== Request

Via curl:
include::{snippets}/organizations/remove-admin-rights/ok/curl-request.adoc[]

HTTP request:
include::{snippets}/organizations/remove-admin-rights/ok/http-request.adoc[]

==== Request Headers
include::{snippets}/organizations/remove-admin-rights/ok/request-headers.adoc[]

==== Path Parameters
include::{snippets}/organizations/remove-admin-rights/ok/path-parameters.adoc[]

=== Response

Success when executed as an organization admin:

include::{snippets}/organizations/remove-admin-rights/ok/http-response.adoc[]

When executed as a user of the same organization:

include::{snippets}/organizations/remove-admin-rights/as-user-of-org-x/http-response.adoc[]

When executed as an admin of a different organization:

include::{snippets}/organizations/remove-admin-rights/admin-of-org-y/http-response.adoc[]
